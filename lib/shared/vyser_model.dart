...
Widget wrapWithModel<T extends VyserModel>({
  required T model,
...
T createModel<T extends VyserModel>(
...
abstract class VyserModel<W extends Widget> {
...
class FlutterFlowDynamicModels<T extends VyserModel> {
